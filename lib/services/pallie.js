...
class PallieService extends Schmervice.Service {
    ...
    */
    async getById(pallieId, txn) {
        ...
        return await this.Pallie.query(txn).findById(pallieId).modify('identityRelations');
    }
    ...
    */
    async getByUsername(username, txn) {
        ...
        return await this.Pallie.query(txn).findOne('username', username).modify('identityRelations');
    }
    ...
    */
    async getAll(txn) {
        ...
        return await this.Pallie.query(txn).modify('identityRelations');
    }
