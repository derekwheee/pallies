...
module.exports = class AuthService extends Schmervice.Service {
    ...
    async register(clientId, name, email, password, txn) {

        return await this.UserService.create(clientId, { name, email, password }, txn);
    }
    ...
    async invite(request, clientId, name, email, force, txn) {
        ...
        await this.register(clientId, name, email, tempPassword, txn);
    ...
    async resetPassword(oldPassword, newPassword, txn) {

        return await this.UserService.resetPassword(oldPassword, newPassword, txn);
    }
};
