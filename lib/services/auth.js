...
class AuthService extends Schmervice.Service {
    ...
    * @param {string} user.identifier - The user's identifier
    * @param {string} password - The user's password
    * @returns {bool}
    */
    ...
    */
    async invite(user, force, txn) {
        ...
        const existingUser = await this.UserService.getByIdentifier(identifier, txn);
    ...
    */
    async forgotPassword(identifier, txn) {
        ...
        const user = await this.UserService.getByIdentifier(identifier, txn);
