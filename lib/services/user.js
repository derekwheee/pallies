...
class UserService extends Schmervice.Service {
    ...
    */
    async getById(userId, txn) {
        ...
        return await this.User.query(txn).findById(userId).withGraphFetched('role');
    }
    ...
    */
    async getByUsername(username, txn) {
        ...
        return await this.User.query(txn).findOne('username', username).withGraphFetched('role');
    }
    ...
    */
    async getAll(txn) {
        ...
        return await this.User.query(txn).withGraphFetched('role');
    }
