...
class UserService extends Schmervice.Service {
    ...
    */
    async getById(userId, txn) {
        ...
        return await this.User.query(txn).findById(userId).modify('allRelations');
    }
    ...
    */
    async getByUsername(username, txn) {
        ...
        return await this.User.query(txn).findOne('username', username).modify('allRelations');
    }
    ...
    */
    async getAll(txn) {
        ...
        return await this.User.query(txn).modify('allRelations');
    }
